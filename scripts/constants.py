...
ESG_METRICS = [
    # Not working: "CO2_NO_EQUIVALENTS", (No associated rows in esg_nasdaq_100 or metrics)
    # Bug: "COMPCOMMNONEXECMEMBERS", All values: 100.0 so it's just ordering by company name
    ...
    # # Environmental Risk
    # "AIRPOLLUTANTS_DIRECT", "AIRPOLLUTANTS_INDIRECT", "CO2DIRECTSCOPE1", "CO2INDIRECTSCOPE2", "CO2INDIRECTSCOPE3", 
    # "HAZARDOUSWASTE", "NATURAL_RESOURCE_USE_DIRECT", "NOXEMISSIONS", "N_OXS_OX_EMISSIONS_REDUCTION",
    ...
    # # Governance Risk
    # "ANALYTICNONAUDITAUDITFEESRATIO", "ANALYTIC_ANTI_TAKEOVER_DEVICES", "ANNUAL_MEDIAN_COMPENSATION", "AUDITCOMMNONEXECMEMBERS", "CALL_MEETINGS_LIMITED_RIGHTS", "CEO_ANNUAL_COMPENSATION", "CEO_PAY_RATIO_MEDIAN", 
    "COMPCOMMNONEXECMEMBERS", "CSR_REPORTINGGRI", "CSR_REPORTING_EXTERNAL_AUDIT", "ELIMINATION_CUM_VOTING_RIGHTS",
    # Social Opportunity
